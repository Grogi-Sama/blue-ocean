...
RT.STRINGS = {
  tr: {
    ...
    pack1: "Bir Avuç İnci", pack2: "İnci Kesesi", pack3: "İnci Kavanozu",
    pack4: "İstiridye Dolusu", pack5: "Hazine Sandığı", pack6: "Poseidon'un Hazinesi",
    ...
    continueCoins: "{c} 🪙 ile Devam Et", oneLifeCoins: "+1 ❤️ ({c} 🪙)",
  ...
  en: {
    ...
    pack1: "Handful of Pearls", pack2: "Pearl Pouch", pack3: "Pearl Jar",
    pack4: "Oyster Full", pack5: "Treasure Chest", pack6: "Poseidon's Hoard",
    ...
    continueCoins: "Continue for {c} 🪙", oneLifeCoins: "+1 ❤️ ({c} 🪙)",

...
RT.STRINGS = {
  tr: {
    ...
    livesTitle: "Canlar", livesFull: "Canların dolu, iyi oyunlar!",
    adLivesLeft: "Bugün reklamla {n} can daha alabilirsin", adLivesNone: "Bugünlük reklam hakkın bitti", refillCoins: "Canları Doldur ({c} 🪙)",
  ...
  en: {
    ...
    livesTitle: "Lives", livesFull: "Your lives are full, have fun!",
    adLivesLeft: "You can get {n} more lives from ads today", adLivesNone: "No more ad lives today", refillCoins: "Refill Lives ({c} 🪙)",
